...
const page = () => {
  ...
  const onSubmit = async (data) => {
    ...
    // console.log(data);
    try {
      const response = await axios.post("/api/auth/seller-signup", data);
  ...
  return (
    <div className=" flex justify-center bg-black ">
      <div className="px-4 sm:px-10 my-32 border flex flex-col gap-7 py-14 justify-center items-center  bg-gray-800 border-white rounded-xl">
        <h1 className="text-4xl text-white font-bold">Cascade</h1>
        <p className="text-gray-400 font-bold">Sign up as a Seller.</p>
        {isSubmitting && (
